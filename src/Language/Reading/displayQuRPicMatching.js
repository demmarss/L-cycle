...
class ReadingPicMatchingQuestion extends Component {
    ...
    handleOnClickImage = (imageName) =>{
        console.log(imageName)
        this.setState({
            answerSelect: imageName,
            submit: false
        })
    ...
    handleFinish = (e) =>{
        ...
        for (let i=0; i<this.state.answerArray.length; i++){
            if (tasky.questions[i].answerImageName === this.state.answerArray[i]) {
                    ...
                    (<article className="message is-link">
                            ...
                            <div className="columns">
                                ...
                                <div className="column is-half">
                                    <h1>Answer</h1>
                                    <figure className="image is-square">
                                        <img src={apiUrlForImages+"/uploads/"+this.state.answerSelect} alt=""/>
                                    </figure>
                                </div>
                            ...
                            <div className="columns">
                                <div className="column">
                                    <figure className="image is-128x128" onClick={() => this.handleOnClickImage(tasky.questions[counter].ArrayOptions[0])}>
                                        <img src={apiUrlForImages+"/uploads/"+tasky.questions[counter].ArrayOptions[0]} alt=""/>
                                    </figure> 
                                </div>
                                <div className="column">
                                    <figure className="image is-128x128" onClick={() => this.handleOnClickImage(tasky.questions[counter].ArrayOptions[1])}>
                                        <img src={apiUrlForImages+"/uploads/"+tasky.questions[counter].ArrayOptions[1]} alt=""/>
                                    </figure> 
                                </div>
                                <div className="column">
                                    <figure className="image is-128x128" onClick={() => this.handleOnClickImage(tasky.questions[counter].ArrayOptions[2])}>
                                        <img src={apiUrlForImages+"/uploads/"+tasky.questions[counter].ArrayOptions[2]} alt=""/>
                                    </figure> 
                                </div>
                                <div className="column">
                                    <figure className="image is-128x128" onClick={() => this.handleOnClickImage(tasky.questions[counter].ArrayOptions[3])}>
                                        <img src={apiUrlForImages+"/uploads/"+tasky.questions[counter].ArrayOptions[3]} alt=""/>
                                    </figure> 
                                </div>
                            </div>
                            <div className="field">
